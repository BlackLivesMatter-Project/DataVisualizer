...
from .data_parser_exception import DataParserFileNotExist, \
    DataParserFileNotReadable, DataParserNotAFile, DataParserNotAnInteger
...
class DataParser:
    ...
    def collect_users_by_followers(self, min_followers=None, max_followers=None):
        ...
        #sort dataframe
        follower_dataframe = follower_dataframe.sort_values(
            'number_of_followers',
            ascending=False,
            ignore_index=True)
    ...
    def collect_retweets(self, max_count=None):
        ...
        # sort dataframe
        retweet_dataframe = retweet_dataframe.sort_values(
            'number_of_retweets',
            ascending=False,
            ignore_index=True)
